  ...
  return (
    <div className="w-[80.0rem] h-[115.625rem] relative bg-white overflow-hidden mx-auto my-12">
      {/* ABSOLUTE POSITIONED TIMELINE BLOCK */}
        ...
        <div className="w-96 h-0 left-[40.0rem] top-[23.5rem] absolute origin-top-left rotate-90 outline outline-2 outline-offset-[-0.0625rem] outline-[#1c6248]"></div>
        ...
        <div className="px-4 py-[0.3125rem] left-[5.5rem] top-[51.875rem] absolute bg-emerald-50 inline-flex justify-center items-center gap-2.5 overflow-hidden">
          <div className="justify-start text-[#1c6248] text-2xl font-semibold font-['Montserrat'] leading-7">Bespoke Conversion Technology</div>
        </div>
        ...
        <div className="px-4 py-[0.3125rem] left-[51.75rem] top-[73.5625rem] absolute bg-emerald-50 inline-flex justify-center items-center gap-2.5 overflow-hidden">
          <div className="justify-start text-[#1c6248] text-2xl font-semibold font-['Montserrat'] leading-7">Industrial Decarbonization</div>
        </div>
        ...
        <div className="px-4 py-[0.3125rem] left-[5.875rem] top-[93.8125rem] absolute bg-emerald-50 inline-flex justify-center items-center gap-2.5 overflow-hidden">
          <div className="justify-start text-[#1c6248] text-2xl font-semibold font-['Montserrat'] leading-7">Carbon Market Integration</div>
        </div>
        ...
        <button className="w-32 h-10 px-5 py-3 left-[5.875rem] top-[106.875rem] absolute bg-[#1c6248] rounded-lg outline outline-[0.075rem] outline-offset-[-0.075rem] outline-[#1c6248] inline-flex justify-center items-center gap-2.5 overflow-hidden">
        ...
        <div className="w-24 h-8 left-[51.1875rem] top-[22.25rem] absolute bg-[#1c6248] rounded-xl outline outline-2 outline-offset-[-0.125rem] outline-[#1c6248] overflow-hidden">
        ...
        <div className="w-96 h-0 left-[17.0625rem] top-[47.375rem] absolute outline outline-2 outline-offset-[-0.0625rem] outline-[#1c6248]"></div>
        <img
        ...
        <div className="w-[37.5625rem] left-[21.1875rem] top-[5.0rem] absolute text-center justify-start">
          ...
          <span className="text-[#1c6248] text-4xl font-semibold font-['Montserrat'] leading-[3.125rem]">Climitra Engine</span>
        </div>
        <div className="w-32 h-0 left-[35.8125rem] top-[9.25rem] absolute outline outline-4 outline-offset-[-0.125rem] outline-[#1c6248]"></div>
        <div className="w-[63.5rem] left-[8.25rem] top-[11.125rem] absolute text-center justify-center">
          ...
          <span className="text-[#1c6248] text-xl font-semibold font-['Montserrat'] leading-loose">vertically integrated ecosystem</span>
